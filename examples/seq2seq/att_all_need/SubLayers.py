...
from att_all_need.Modules import ScaledDotProductAttention

__author__ = "Yu-Hsiang Huang"

class MultiHeadAttention_extra_mask(nn.Module):
    ...
    def forward(self, q, k, v, mask, extra_mask, ratio=0.2):
        ...
        return output_plus_residual, attn1, q
